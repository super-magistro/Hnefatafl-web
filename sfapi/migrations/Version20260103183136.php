 ...
 */
final class Version20260103183136 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, player_attacker_id INT NOT NULL, player_defender_id INT NOT NULL, winner_id INT DEFAULT NULL, board_state JSON NOT NULL COMMENT \'(DC2Type:json)\', status VARCHAR(50) NOT NULL, variant VARCHAR(255) NOT NULL, INDEX IDX_232B318C3DCF2376 (player_attacker_id), INDEX IDX_232B318C1209D2FA (player_defender_id), INDEX IDX_232B318C5DFCD4B8 (winner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
